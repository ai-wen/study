...
#define PACKAGE_URL
#define PACKAGE "wmctrl"
#define VERSION "1.07"

//gcc - DPACKAGE_NAME = \"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\ -DPACKAGE_URL=\"\" -DPACKAGE=\"wmctrl\" -DVERSION=\"1.07\" -I. -I.  -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include  -Wall -g -O2 -MT main.o -MD -MP -MF ".deps / main.Tpo" \
...
static int list_desktops (Display *disp) {/*{{{*/
    ...
    desktop_geometry_str = (gchar**)g_malloc0((*num_desktops + 1) * sizeof(char *));
    ...
    desktop_viewport_str = (gchar**)g_malloc0((*num_desktops + 1) * sizeof(char *));
