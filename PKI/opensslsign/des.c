 ...
 */
int des_crypt_ecb_block( des_context *ctx,
...
/*
 * DES-ECB buffer encryption/decryption
 */
                    ...
                    unsigned char *output )
{
    ...
    if( mode == DES_ENCRYPT )
    {
        while( length > 0 )
        {
            des_crypt_ecb_block( ctx, input, output );
 ...
 */
int des3_crypt_ecb_block( des3_context *ctx,
                     const unsigned char input[8],
                     unsigned char output[8] )
{
    int i;
...
/*
 * 3DES-ECB buffer encryption/decryption
 */
                     ...
                     unsigned char *output )
{
    ...
    if( mode == DES_ENCRYPT )
    {
        while( length > 0 )
        {
            des3_crypt_ecb_block( ctx, input, output );
