...
WIX = F:\AAA-GIT-11111111111111111111111111\3part\wix311-binaries
!ENDIF
...
!IF "$(OPENSSL_DIR)" == ""
!IF "$(PLATFORM)" == "x86"
OPENSSL_DIR = D:\software\OpenSSL-1.0.2u-Win32
!ELSE
...
OPENSSL_LIB = $(OPENSSL_DIR)\lib\ssleay32.lib $(OPENSSL_DIR)\lib\libeay32.lib user32.lib advapi32.lib crypt32.lib ws2_32.lib
# OpenSSL 1.1.0
...
#ZLIB_INCL_DIR = /IF:\AAA-GIT-11111111111111111111111111\3part\zlib
#ZLIB_LIB = F:\AAA-GIT-11111111111111111111111111\3part\zlib\zlib.lib
...
# OPENPACE_DIR = F:\AAA-GIT-11111111111111111111111111\3part\openpace-1.1.1
